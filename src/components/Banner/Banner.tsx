...
const Banner: FC = () => {
  return (
    <div
      id="banner"
      className="banner relative flex w-full items-center justify-between"
    >
      <div className="absolute top-1/2 z-10 -translate-y-1/2 space-y-4 uppercase">
        ...
        <div>
          <button
            type="button"
            className="mb-2 mr-2 rounded-lg bg-gradient-to-r from-green-400 via-green-500 to-green-600 py-2.5 pl-5 pr-3 text-center text-sm font-medium text-white hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800"
          >
